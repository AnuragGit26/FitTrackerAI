    ...
    <div
      className={cn(
        ...
        isCompleted
          ...
          : 'bg-white border-gray-100 dark:bg-surface-dark dark:border-border-dark'
      )}
    >
      <div className="flex-shrink-0 w-8 text-center font-semibold text-slate-500 dark:text-gray-400">
        {set.setNumber}
      </div>
      ...
      <div className="flex-1 grid grid-cols-2 gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="p-1.5 rounded-lg bg-gray-100 dark:bg-surface-dark-light hover:bg-white dark:hover:bg-surface-dark transition-colors"
          ...
          <div className="flex-1 text-center">
            ...
            <div className="text-xs text-slate-500 dark:text-gray-400">{unit}</div>
          </div>
          <button
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 text-center">
            ...
            <div className="text-xs text-slate-500 dark:text-gray-400">reps</div>
          </div>
          <button
        ...
        <button
          ...
          className={cn(
            ...
            isCompleted
              ...
              : 'border-gray-100 dark:border-gray-600 hover:border-primary-500'
          )}
